...
### Ambiguity Handling
If expected behavior is unclear during test design, mark it as blocking and first apply the spec-clarity gate. Route to human verification only if ambiguity remains (do not infer by convenience).
