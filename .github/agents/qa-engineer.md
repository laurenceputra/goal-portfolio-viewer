...
If expected behavior is unclear, mark as blocking and first check whether the spec already satisfies the spec-clarity gate. Route to human verification only if ambiguity remains.
